...
description: A comprehensive test page showcasing all typography styles and prose elements.
---

This page demonstrates all the typography styles available. It serves as both a test page and a reference for content creators.
...
Links are styled with the primary color: [Visit our homepage](/) or check out [GitHub](https://github.com).
...
You can <mark>highlight important information</mark> using the mark element.

### Small Text

<small>This is some fine print that you probably don't need to read.</small>

### Definition Lists

<dl>
  <dt>Eleventy</dt>
  <dd>A simpler static site generator</dd>

  <dt>Tailwind CSS</dt>
  <dd>A utility-first CSS framework</dd>

  <dt>Alpine.js</dt>
  <dd>A lightweight JavaScript framework</dd>
</dl>
